				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="project-navigation">
							<nav>
								<ul class="unstyled">
									<li><a href="vimeo-project.html"><i class="fa fa-angle-double-left"></i> Previous Project</a></li>
									<li class="pull-right"><a href="slider-project.html">Next Project <i class="fa fa-angle-double-right"></i></a></li>
								</ul>
							</nav>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="project-details">
                            ...
                            <a class="custom-button" href="#">Live preview</a>
						</div>
					</div>
